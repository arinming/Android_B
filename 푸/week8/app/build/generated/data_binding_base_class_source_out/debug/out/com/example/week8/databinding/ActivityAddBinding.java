...
package com.example.week8.databinding;
...
public final class ActivityAddBinding implements ViewBinding {
  ...
  private ActivityAddBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnSave,
      @NonNull EditText edtTitle) {
  ...
  public static ActivityAddBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAddBinding((ConstraintLayout) rootView, btnSave, edtTitle);
    }
